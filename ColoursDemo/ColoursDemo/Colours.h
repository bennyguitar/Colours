...
// Grays
#define Color25PercentBlack [UIColor colorWithWhite:0.25 green:1 blue:1 alpha:1.0];
#define Color50PercentBlack [UIColor colorWithWhite:0.5 green:1 blue:1 alpha:1.0];
#define Color75PercentBlack [UIColor colorWithWhite:0.75 green:1 blue:1 alpha:1.0];
